...
from scaffold_hopping.scaffold_2D import results_filt_unique, results_filt
...
def run3D(scaff_1_path, n_cores, use_gpu):
    ...
    return names_frags, best_scores_frags, best_rmsd_frags, names_rmsd_frags
