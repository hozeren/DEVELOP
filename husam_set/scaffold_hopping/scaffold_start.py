...
atom_pair_idx_1 = [9, 11]
atom_pair_idx_2 = [6, 10]
...
# Write data to file
data_path = "./scaffold_hopping_data.txt"
...
preprocess(raw_data, "zinc", "scaffold_hopping", "./", False)

# Calculate Pharmacophoric information
fragments_path = 'scaffold_hopping_fragments.sdf'
pharmacophores_path = 'scaffold_hopping_pharmacophores.sdf'
fragmentations_pharm, fails = frag_utils.create_frags_pharma_sdf_dataset([[scaff_1_smi, linker, fragments, dist, ang]], 
                                                                         ...
                                                                         prot="", verbose=True)
# Write .types file
with open("scaffold_hopping.types", 'w') as f:
