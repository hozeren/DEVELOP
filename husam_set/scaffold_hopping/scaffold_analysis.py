...
from scaffold_hopping.scaffold_start import fragments
#from scaffold_hopping.scaffold_3D_class import names_frags, best_scores_frags, best_rmsd_frags, names_rmsd_frags
...
def run_analysis(names_frags, best_scores_frags, best_rmsd_frags, names_rmsd_frags):
